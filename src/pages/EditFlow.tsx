    ...
    try {
      ...
      if (response.success) {
        ...
        setFormData({
          ...
          filter_countries: flow.filter_countries || [],
          filter_devices: flow.filter_devices || [],
          filter_os: flow.filter_os || [],
          filter_browsers: flow.filter_browsers || [],
          filter_langs: flow.filter_langs || [],
          filter_time_zones: flow.filter_time_zones || [],
          filter_connections: flow.filter_connections || [],
          filter_cloaking_flag: flow.filter_cloaking_flag || 0,
          filter_vpn_proxy_flag: flow.filter_vpn_proxy_flag || 0,
          filter_ip_v6_flag: flow.filter_ip_v6_flag || 0,
          filter_referer_flag: flow.filter_referer_flag || 0,
          filter_isp_flag: flow.filter_isp_flag || 0,
          filter_black_ip_flag: flow.filter_black_ip_flag || 0,
          filter_ip_clicks_per_day: flow.filter_ip_clicks_per_day || 0,
          filter_clicks_before_filtering: flow.filter_clicks_before_filtering || 0,
          mode_list_country: flow.mode_list_country || 1,
          mode_list_device: flow.mode_list_device || 1,
          mode_list_os: flow.mode_list_os || 1,
          mode_list_browser: flow.mode_list_browser || 1,
          mode_list_lang: flow.mode_list_lang || 1,
          mode_list_time_zone: flow.mode_list_time_zone || 1,
          mode_list_connection: flow.mode_list_connection || 1,
          filter_id: flow.filter_id || 0,
