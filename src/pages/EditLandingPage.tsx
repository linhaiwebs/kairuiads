...
const EditLandingPage: React.FC = () => {
  ...
  const loadLandingPageData = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // 设置UI图片预览
        if (landingPage.ui_image) {
          setPreviews(prev => ({
            ...prev,
            ui_image: `/uploads/${landingPage.ui_image}`
          }));
        }
      } else {
  ...
  const removeFile = (fieldName: string) => {
    ...
    if (fieldName === 'ui_image') {
      setPreviews(prev => ({
        ...prev,
        ui_image: currentData?.ui_image ? `/uploads/${currentData.ui_image}` : ''
      }));
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">修改落地页信息和文件</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* File Uploads */}
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">文件管理</h3>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              {currentData?.ui_image && !files.ui_image && (
                <button
                  type="button"
                  onClick={() => handleDownloadFile('ui')}
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">
                      {files.ui_image?.name || '当前图片'}
                    </p>
                    {files.ui_image && (
                      <p className="text-xs text-gray-500">
                        {(files.ui_image.size / 1024 / 1024).toFixed(2)} MB
                      </p>
                    )}
                  </div>
                  <button
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              {currentData?.source_file && !files.source_file && (
                <button
                  type="button"
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-indigo-400 transition-colors duration-200">
              {files.source_file ? (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">当前源文件</p>
                    <p className="text-xs text-gray-500">{currentData.source_file}</p>
                  </div>
                  <label className="cursor-pointer bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700 transition-colors duration-200">
                    替换文件
                    <input
                      type="file"
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              {currentData?.download_file && !files.download_file && (
                <button
                  type="button"
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-indigo-400 transition-colors duration-200">
              {files.download_file ? (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">当前下载文件</p>
                    <p className="text-xs text-gray-500">{currentData.download_file}</p>
                  </div>
                  <label className="cursor-pointer bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700 transition-colors duration-200">
                    替换文件
                    <input
